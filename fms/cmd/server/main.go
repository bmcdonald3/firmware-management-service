...
import (
	...
	. "github.com/bmcdonald3/fms/internal/middleware"
...
func runServer(cmd *cobra.Command, args []string) error {
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "fms.resource"
	}
...
// Library upload and file serving routes
r.Post("/library/upload", libraryUploadHandler)
r.Get("/library/files/*", http.StripPrefix("/library/files/", http.FileServer(http.Dir(firmwareDestDir))).ServeHTTP)
